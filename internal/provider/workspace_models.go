...
func workspaceResourceModelFromAPI(
	...
	model := &workspaceResourceModel{
		...
		AutoQueueRuns:             types.StringValue(string(ws.Attributes.AutoQueueRuns)),
		...
		ExecutionMode:             types.StringValue(string(ws.Attributes.ExecutionMode)),
		...
		IaCPlatform:               types.StringValue(string(ws.Attributes.IacPlatform)),
		...
		Type:                      types.StringValue(string(ws.Attributes.EnvironmentType)),
