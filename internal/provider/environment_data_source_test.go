		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.scalr_environment.test", "remote_backend", "true"),
					resource.TestCheckResourceAttr("data.scalr_environment.test", "remote_backend_overridable", "true"),
