...
- `comments_enabled` (Boolean) Enable comments on pull requests for the VCS provider.
...
- `pr_merge_comments_enabled` (Boolean) Enable comments after pull request merges for the VCS provider.
