...
- `scalr_workspace`: added new attribute `deletion_protection` ([#242](https://github.com/Scalr/terraform-provider-scalr/pull/242))
- `data.scalr_workspace`: added new attribute `deletion_protection` ([#242](https://github.com/Scalr/terraform-provider-scalr/pull/242))
