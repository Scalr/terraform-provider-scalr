...
- `scalr_vcs_provider`: fix handling resource destroy when resource is no longer exists ([#224](https://github.com/Scalr/terraform-provider-scalr/pull/224))
- `scalr_webhook`: fix handling resource destroy when resource is no longer exists ([#235](https://github.com/Scalr/terraform-provider-scalr/pull/235))
