...
- `scalr_vcs_provider` and `data.scalr_vcs_provider`: new attributes `comments_enabled` and `pr_merge_comments_enabled` ([#535](https://github.com/Scalr/terraform-provider-scalr/issues/535)).
...
- `scalr_provider_configuration` and `data.scalr_provider_configurations`: Scalr tags support added; ([#494](https://github.com/Scalr/terraform-provider-scalr/pull/494))

### Required

- scalr-server >= 2602.13.0
...
- `scalr_role`: attribute `account_id` is deprecated and will be removed in the next major version ([#425](https://github.com/Scalr/terraform-provider-scalr/pull/425))
