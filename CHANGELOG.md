...
- `data.scalr_current_run` requires scalr server >= `8.0.1-beta.CURRENT_RELEASE_VERSION`
...
[Unreleased]: https://github.com/Scalr/terraform-provider-scalr/compare/v1.0.0-rc7...HEAD
