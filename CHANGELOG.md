...
- `scalr_vcs_provider`: added new attribute `environments` ([#242](https://github.com/Scalr/terraform-provider-scalr/pull/242))
- `data.scalr_vcs_provider`: attribute `environments` now can return `["*"]` for shared providers ([#242](https://github.com/Scalr/terraform-provider-scalr/pull/242))
